...
- **Pantograph** A texual-semantic code editor with embedding gaps and no support for invalid syntax. Users directly instatiate the typed representation of the code being edited. Heading towards multi-language support. Likely the current overall leader in editor UX innovation in my view, though the product is not yet market-ready.
